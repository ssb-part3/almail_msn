/* --------------------------------------------------------------- *
 *
 * SYSTEM NAME   : ssBridge
 * SUB NAME      : MD5 관련 모듈 모음
 * DESC.         : 1) MD5 암호화 관련 모듈
 *
 * COPYRIGHT     : SQIsoft Co,.Ltd.
 *
 * DATE          : 2008.7.14
 * NAME          : LEE DonGyu
 *
...
char *MD5_version="MD5 part of RSADLX 1.0";
...
unsigned long len;
	...
	/* Fixed a bug with the overflow handling, thanks to
